import { getImageFilters, removeDuplicates, convertArrayToFilterObject} from './HubImagesList'
import { HubImage} from "../../redux/hub/hub.types"

describe('removeDuplicates', () => {
    it('removes duplicate elements in an array', () => {
        expect(removeDuplicates(['Leo', 'Rafa', 'Don', 'Mike', 'Don'])).toEqual(['Leo', 'Rafa', 'Don', 'Mike'])
...
describe('convertArrayToFilterObject', () => {
    it('convert array to object with value false', () => {
        expect(convertArrayToFilterObject(['a', 'b', 'c'])).toEqual({a: false, b: false, c: false})
    })
})
...
describe('getImageFilters', () => {
    ...
    const images = [
        {
            ...
            "version": "0.0.6",
            "jina-version": "0.9.20",
            "docker-command": "docker pull jinahub/pod.encoder.bigtransferencoder:0.0.6-0.9.20",
        ...
        },
        {
            ...
            "version": "0.0.8",
            "jina-version": "0.9.19",
            "docker-command": "docker pull jinahub/pod.encoder.chromapitchencoder:0.0.8-0.9.19",
        ...
        },
        {
            ...
            "version": "0.0.5",
            "jina-version": "0.9.20",
            "docker-command": "docker pull jinahub/pod.encoder.compressionvaeencoder:0.0.5-0.9.20",
    ...
    const expectedFilters = [
        ...
        },
        {
            ...
            values: {"Tensorflow": false, "Computer Vision": false, "encoder": false, "audio": false, "chromagrams": false, "Variational Autoencoders": false},
        }
    ]

    expect(getImageFilters(images as unknown as HubImage[])).toEqual(expectedFilters)
})
})